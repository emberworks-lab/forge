...
2. Copy the 4 skeleton files from `~/.claude/skill-templates/_common/docs/00_meta/`:
   - `decisions-log.md`
   - `roadmap.md`
   - `docs-workflow.md`
   - `glossary.md`
...
| `~/.claude/docs/conventions/docs-workflow.md` | Universal pattern (this is what `00_meta/docs-workflow.md` is an instance of) |
```
